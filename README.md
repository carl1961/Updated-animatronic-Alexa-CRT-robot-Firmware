...
Updated the animatronic Alexa CRT robot Firmware, for FM225 Facial Recognition Module HLK-FM225  

[breathing-life-into-an-amazon-echo-device] (https://www.hackster.io/tmburns/breathing-life-into-an-amazon-echo-device-ed9ea3)

[A Workbench Companion, from an Amazon Echo Dot] (https://hackaday.io/project/189041-a-workbench-companion-from-an-amazon-echo-dot)
